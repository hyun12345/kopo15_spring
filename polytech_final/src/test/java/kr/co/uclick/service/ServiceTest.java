...
//	}
	...
	//***user name Like List 검색 테스트***
//	@Test
//	public void search_user() {
//		List<User> user = userService.findUserByNameLike("지");
//		assertEquals(2, user.get(0).getId().longValue());
//	}
...
//		Phone phone = phoneService.findPhoneByNumber("010-1234-5678");
//		assertEquals(2, phone.getId().longValue());
//	}
	
	//***user name Like List 쿼리캐시 검색 테스트***
	@Test
	public void search_user() {
		StopWatch sw = new StopWatch();
		sw.start();
		List<User> user = userService.findUserByNameLike("a");
		sw.stop();
		System.out.println("1-**<<NUMBER ONE TOTAL TIME : " + sw.getTotalTimeSeconds() + ">>**-");
		
		sw = new StopWatch();
		sw.start();
		user = userService.findUserByNameLike("a");
		sw.stop();
		System.out.println("2-**<<NUMBER TWO TOTAL TIME : " + sw.getTotalTimeSeconds() + ">>**-");

		user.get(0).setName("abc");
...
//		StopWatch sw = new StopWatch();
//		sw.start();
//		Phone phone = phoneService.findPhoneByNumber("010-1717-1717");
//		sw.stop();
//		System.out.println("1-**<<NUMBER ONE TOTAL TIME : " + sw.getTotalTimeSeconds() + ">>**-");
//		
//		sw = new StopWatch();
//		sw.start();
//		phone = phoneService.findPhoneByNumber("010-1717-1717");
//		sw.stop();
//		System.out.println("2-**<<NUMBER TWO TOTAL TIME : " + sw.getTotalTimeSeconds() + ">>**-");
//
//		phone.setNumber("010-111-1111");
//		phoneService.save(phone);
//		sw = new StopWatch();
//		sw.start();
//		phone = phoneService.findPhoneByNumber("010-111-1111");
//		sw.stop();
//		System.out.println("3-**<<NUMBER THREE TOTAL TIME : " + sw.getTotalTimeSeconds() + ">>**-");
//
//		sw = new StopWatch();
