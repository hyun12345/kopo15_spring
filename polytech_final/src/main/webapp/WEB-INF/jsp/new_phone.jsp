	...
	<form method=post name=phone_insert>
		<center>
					...
					<tr>
						...
						<td>
							<div class="ui small form">
								<input type=text title="ex)010-1234-5678" placeholder="전화번호를 입력하십시오." name=number size=30 maxlength=20 required>
							</div> 
						</td>
					</tr>
					<tr>
			...
			<table align=center>
				<tr>
					<td width=250></td>
					<td align=right><input type=button class="small ui blue button" value="취소" OnClick="location.href='list'"></td>
					<td align=right>
						<input type=button class="small ui blue button" value="쓰기" OnClick="submitForm()"></td>
				</tr>
			</table>
		</center>
	</form>
