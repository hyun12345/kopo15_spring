		...
		<center>
			...
			<table border=0 align=center>
				<tr>
					...
					<td align=right>
						<input type=button class="small ui blue button" OnClick="submitForm()" value="수정">
						</td>
					<td align=right>
						<input type=button class="small ui blue button" OnClick="location.href='delete_phone?key=${phoneUpdate.id}'" value="삭제">
						</td>
				</tr>
			</table>
		</center>
